...
<script lang="ts" setup>
  ...
  onMounted(()=>{
    add_script('https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/DrawSVGPlugin3.min.js');
    add_script('https://cdnjs.cloudflare.com/ajax/libs/lodash.js/4.17.15/lodash.min.js');
    add_script('https://unpkg.com/gsap@3/dist/gsap.min.js');

    setTimeout(() => {
      add_script('/src/components/Animations/BongoCat/bongoCat.ts');
    }, 1000)
  })
