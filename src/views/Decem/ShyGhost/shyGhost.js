...
class Ghost {
    ...
    reset() {
        ...
        this.scene.style.left = Math.floor(Math.random() * (document.querySelector('.shyGhost-container').getBoundingClientRect().width - 140)) + 'px';
        this.scene.style.top = Math.floor(Math.random() * (document.querySelector('.shyGhost-container').getBoundingClientRect().height - 160)) + 'px';
        this.scene.classList.add('descend');
        this.shadow.classList.add('disappear');
        document.querySelector('.shyGhost-container').append(this.scene);
        this.enter();
    }
